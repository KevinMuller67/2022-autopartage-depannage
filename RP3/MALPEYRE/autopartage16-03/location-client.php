...
<body>
            ...
            <h1>Autopartage
                ...
                <ul id="menu-demo2">
                    ...
                    <li><a href="#">location</a>
                        <ul>
                            <li><a href="location-client.php">Location</a></li>
    ...
    echo "<tr><th>Id</th><th>Nom</th><th>Prenom</th><th>AdresseMail</th></tr>";
    ...
    try {
        ...
        $stmt = $conn->prepare("SELECT idClient, Nom, Prenom, AdresseMail FROM Loueur");
        $stmt->execute();
