...
<body>
    ...
    <div id="nav">
            ...
            <h1>Autopartage
                ...
                <ul id="menu-demo2">
                    ...
                    <li><a href="#">location</a>
                        <ul>
                            <li><a href="location-client.php">Client</a></li>
        ...
        echo "<tr><th>Id</th><th>Nom</th><th>AdresseMail</th></tr>";
        ...
        try {
            ...
            $stmt = $conn->prepare("SELECT idProprio, Nom, AdresseMail FROM proprietaire");
            $stmt->execute();
